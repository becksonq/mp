...
class Formatter extends Component
{
    ...
    /**
     * @var \IntlCalendar|int|null the event-calendar to be used for date formatting. The value of this property will be directly
     * passed to the [constructor of the `IntlDateFormatter` class](http://php.net/manual/en/intldateformatter.create.php).
     *
     * Defaults to `null`, which means the Gregorian event-calendar will be used. You may also explicitly pass the constant
     * `\IntlDateFormatter::GREGORIAN` for Gregorian event-calendar.
     *
     * To use an alternative event-calendar like for example the [Jalali event-calendar](https://en.wikipedia.org/wiki/Jalali_calendar),
     * set this property to `\IntlDateFormatter::TRADITIONAL`.
     * The event-calendar must then be specified in the [[locale]], for example for the persian event-calendar the configuration for the formatter would be:
     *
     * ```php
     * 'formatter' => [
     *     'locale' => 'fa_IR@event-calendar=persian',
     *     'event-calendar' => \IntlDateFormatter::TRADITIONAL,
     * ],
     * ```
     *
     * Available event-calendar names can be found in the [ICU manual](http://userguide.icu-project.org/datetime/calendar).
     *
